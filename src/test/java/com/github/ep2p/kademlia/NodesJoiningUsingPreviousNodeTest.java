...
public class NodesJoiningUsingPreviousNodeTest {
    ...
    public void canPeersJoinNetwork() throws BootstrapException, InterruptedException {
        ...
        KademliaNode<EmptyConnectionInfo> previousNode = new KademliaNode<>(nodeApi, nodeIdFactory, new EmptyConnectionInfo(), routingTableFactory);
        LocalNodeApi.registerNode(previousNode);
